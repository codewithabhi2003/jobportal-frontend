    ...
    return (
        <div className="bg-white shadow-lg rounded-xl overflow-x-auto border border-gray-200">
            <Table className="w-full text-xs sm:text-sm min-w-[640px]">
                <TableCaption className="text-gray-500 mt-2 text-xs sm:text-sm">
                    A list of your applied jobs
                </TableCaption>

                <TableHeader className="bg-gray-100">
                    <TableRow>
                        <TableHead className="px-3 sm:px-6 py-2 sm:py-3 text-left text-gray-700">
                            Date
                        </TableHead>
                        <TableHead className="px-3 sm:px-6 py-2 sm:py-3 text-left text-gray-700">
                            Job Role
                        ...
                        <TableHead className="px-3 sm:px-6 py-2 sm:py-3 text-right text-gray-700">
                            Status
                        </TableHead>
                    </TableRow>
                </TableHeader>
                    ...
                    <TableBody>
                        {allAppliedJobs.map((appliedJob, index) => (
                            ...
                            >
                                ...
                                <TableCell className="px-3 sm:px-6 py-3 sm:py-4 font-medium text-gray-800">
                                    {appliedJob?.job?.title || "N/A"}
                                </TableCell>

                                <TableCell className="px-3 sm:px-6 py-3 sm:py-4 text-gray-700">
                                    {appliedJob?.job?.company?.name || "N/A"}
                                </TableCell>

                                <TableCell className="px-3 sm:px-6 py-3 sm:py-4 text-right">
                                    <Badge
                                        className={`px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs font-semibold uppercase rounded-full ${
