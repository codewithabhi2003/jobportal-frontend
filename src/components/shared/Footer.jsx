...
const Footer = () => (
  <>
    <style>{`
      ...
      .jpfooter { background: #18003a; font-family: 'Outfit', sans-serif; position: relative; overflow: hidden; }
      .jpfooter-glow { position: absolute; top: -60px; left: 50%; transform: translateX(-50%); width: 600px; height: 180px; border-radius: 50%; background: radial-gradient(circle, rgba(114,9,183,0.25) 0%, transparent 70%); filter: blur(40px); pointer-events: none; }
      .jpfooter-inner { max-width: 1280px; margin: 0 auto; padding: 3.5rem 1.5rem 2rem; position: relative; z-index: 1; }
      .jpfooter-top { display: grid; grid-template-columns: 1.5fr 1fr 1fr 1fr; gap: 2.5rem; padding-bottom: 2.5rem; border-bottom: 1px solid rgba(255,255,255,0.07); margin-bottom: 1.75rem; }
      ...
      .jpfooter-logo { font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; font-size: 1.3rem; color: #fff; letter-spacing: -0.03em; text-decoration: none; display: inline-block; }
      ...
      .jpfooter-social { width: 34px; height: 34px; border-radius: 8px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.1); display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.45); text-decoration: none; transition: all 0.2s; }
      ...
      .jpfooter-bottom { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.75rem; }
      .jpfooter-copy { color: rgba(255,255,255,0.25); font-size: 0.8rem; }
      .jpfooter-copy span { color: rgba(180,75,247,0.6); }
      .jpfooter-badge { display: inline-flex; align-items: center; gap: 6px; padding: 0.28rem 0.75rem; border-radius: 7px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08); color: rgba(255,255,255,0.35); font-size: 0.73rem; }
          ...
          <div className="jpfooter-brand">
            ...
            <div className="jpfooter-socials">
              {SOCIALS.map((social) => {
                ...
                return (
                  <a key={social.label} href={social.href} className="jpfooter-social" aria-label={social.label}>
                    <SocialIcon />
                  </a>
                );
              })}
