...
import { Loader2, User, Mail, Phone, Lock, ImagePlus } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
...
const Signup = () => {
  const [input, setInput] = useState({
    fullname: "", email: "", phone: "", password: "", role: "", file: ""
  });
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="auth-field">
                ...
                <div className="auth-input-wrap">
                  ...
                  <input className="auth-input" name="password" type="password" value={input.password}
                    onChange={changeEventHandler} placeholder="Create a strong password" />
                </div>
              </div>
