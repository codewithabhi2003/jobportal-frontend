    ...
    <>
      <style>{`
        ...
        .upd-modal {
          ...
          padding: 0 !important;
          overflow: hidden;
          box-shadow: 0 20px 60px rgba(114,9,183,0.15), 0 4px 16px rgba(0,0,0,0.06) !important;
        ...
        .upd-title {
          ...
          font-size: 1.2rem; font-weight: 800; color: #18003a;
        ...
        .upd-close {
          ...
          color: #7209b7; cursor: pointer; transition: all 0.18s;
        }
        ...
        .upd-label {
          ...
          color: #4b006e; margin-bottom: 0.38rem;
          font-family: 'Outfit', sans-serif;
        }
        ...
        .upd-input {
          ...
          border-radius: 10px;
          font-family: 'Outfit', sans-serif;
          font-size: 0.88rem; color: #18003a;
        ...
        .upd-file-label {
          ...
          border: 1.5px dashed rgba(114,9,183,0.28);
          border-radius: 10px;
          font-family: 'Outfit', sans-serif;
        ...
        .upd-file-label:hover {
          border-color: #7209b7;
          background: rgba(114,9,183,0.03); color: #7209b7;
        }
        .upd-file-name {
          font-size: 0.82rem; color: #7209b7; font-weight: 500;
